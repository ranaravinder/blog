...
const navItems = {
  ...
  // '/utisthabharat': {
  //   name: '॥ उत्तिष्ठ भारत ॥',//'Utistha Bharat',
  //   x: 182,
  //  y: 104,
  //   w: '100px',
  // },
...
function Logo() {
  return (
    <Link aria-label="Rana Ravinder Singh" href="/">
      <img src="rlogo.png" width="25" height="37"></img>
      {/* <motion.svg
...
export default function Navbar() {
  ...
  return (
    <aside className="md:flex-shrink-0 -mx-4 md:mx-0 md:px-0 font-serif">
